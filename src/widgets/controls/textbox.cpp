...
void carbon::textbox::handle_draw() {
	...
	buf->draw_text(text, { textbox.x + theme.textbox_padding.x, textbox.y + theme.textbox_padding.y }, use_placeholder ? renderer::color_rgba(210, 210, 210, 255) : COLOR_WHITE, main_font, renderer::align_top_left);
}
...
void carbon::textbox::handle_input() {
	...
	const auto last_key = get_last_key();
